...
public:              //将private改为public
	...
	*/
private:
	static UINT WINAPI ListenThread(void* pParam); //静态成员函数，静态成员函数不能访问本类中的非静态数据成员，静态成员函数主要用来访问静态数据成员
...
private:
	...
	/** 线程退出标志变量 */
	static bool s_bExit; //静态数据成员，在内存中只占一份空间，为各对象所共有
